...
def main(length, temperature, prefix):
    '''
    ...
    parser.add_argument('--model_path', default='Model_100', type=str, required=False, help='模型路径')
    parser.add_argument('--prefix', default=input, type=str, required=False, help='生成文章的开头')
    ...
    topk = 8
    topp = 0
    model_config = 'cache/vocab_small.txt'
    tokenizer_path = 'cache/vocab_small.txt'
    model_path = 'model_epoch350'
    #prefix
    segment = False
    fast_pattern = False
    ...
    for _ in range(nsamples // batch_size):
        ...
        for i in range(batch_size):
            ...
            tmp_sentence = generate_sentence.split(raw_text)[1]
            tmp_en = ts.google(tmp_sentence, from_language='zh-TW', to_language='en')
            print("English :", tmp_en)
            return ts.google(tmp_en, from_language='en', to_language='zh-TW')
